// Implement nightly features in stable rustc compiler
#![feature(lang_items)]
#![feature(auto_traits)]
#![feature(no_core)]
...
// Implements the macros that I need
macro_rules! matches {
...
// Add traits and import compiler stuff that I need
#[lang = "sized"]
pub trait Sized {}
#[lang = "freeze"]
auto trait Freeze {}
...
// (re)implements Option (who never did it? 😅)
enum Option<T> {
    Some(T),
    None,
}
...
const DUPLICATE: u64 = {
    ...
    const fn burn(item: usize, compare: usize) -> u64 {
